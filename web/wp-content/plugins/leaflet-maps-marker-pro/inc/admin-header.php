	...
	if ( lmm_validate_license_info() ) {
		...
		if ($page != 'leafletmapsmarker_license') {
			...
			if (version_compare($latest_pro_version,$plugin_version,">")){
				echo __('Latest available version:','lmm') . " <a href='https://www.mapsmarker.com/v4.0' target='_blank' title='" . esc_attr__('click to show release notes','lmm') . "'>" . $latest_pro_version . "</a> " . "(<a href='www.mapsmarker.com/changelog/pro/' target='_blank'>" . __('show all available changelogs','lmm') . "</a>)<br/>";
			}
...
if ($lmm_options['misc_whitelabel_backend'] == 'disabled') {
	...
	echo '<div style="font-size:1.5em;margin-top:7px;"><span style="font-weight:bold;">Maps Marker Pro<sup style="font-size:75%;">&reg;</sup> <a href="https://www.mapsmarker.com/v4.0" target="_blank" title="' . esc_attr__('view blogpost for current version','lmm') . '">v' . $pro_version['Version'] . '</a></span>';
	echo '<div style="float:right;padding-right:15px;"><a href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_update_mmp4">' . __('Interim version needed to update to Maps Marker Pro 4.0 - please click here for next steps!','lmm') . '</a></div>';
