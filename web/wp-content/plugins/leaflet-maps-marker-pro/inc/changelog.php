...
<?php
/*****************************************************************************************/
echo '<p style="margin:0.5em 0 0 0;clear:both;"><strong>Changelog for v3.1.1</strong> (released on 18.10.2018)</p>
<h2><a href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_update_mmp4" target="_top">Interim version needed to update to Maps Marker Pro 4.0 - please click here for next steps!</a></h2>
<table>
<tr><td>' . $changed . '</td><td>
replaced (retired) Visualead with Google QR code generator
</td></tr>
<tr><td>' . $fixed . '</td><td>
...
<tr><td>' . $fixed . '</td><td>
mixed content warnings for OSM basemap variants OSM-DE and OSM France
</td></tr>
<tr><td>' . $fixed . '</td><td>
visibility of Google Maps attribution
</td></tr>
</table>'.PHP_EOL;
