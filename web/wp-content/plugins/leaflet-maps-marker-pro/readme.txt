...
Display locations and directions on your WordPress site. Organize customized icons in tidy layers on a variety of maps and even in augmented reality browsers. Maps Marker Pro is your individual Geo-CMS that features highest security standards and a moral code.
...
* Ukrainian (uk_UK) thanks to Andrexj, Sergey Zhitnitsky and Mykhailo
...
== Upgrade Notice ==
= 3.1.1 =
This is an interim version for the update to Maps Marker Pro 4.0 - see [https://www.mapsmarker.com/v4.0p](https://www.mapsmarker.com/v4.0p) for more details

== Changelog ==
= 3.1.1 =
interim version for the update to Maps Marker Pro 4.0 - see [https://www.mapsmarker.com/v4.0p](https://www.mapsmarker.com/v4.0p) for more details
